...
![RcloneBrowser upload](./images/rclone_browser_upload.jpg){#fig-rclonebrowser-upload}
 
 4. On the `source` row, click the **Choose folder** icon and select the tidied mission folder on your local PC. Check that the `destination` looks correct and click `Run` (@fig-rclonebrowser-upload-options).
 
![RcloneBrowser upload options](./images/rclone_browser_upload_options.jpg){#fig-rclonebrowser-upload-options}
