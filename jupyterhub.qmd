...
**Choose the resources you need from the links below and login using your Feide credentials.**

 * **[Standard](https://hub-standard.seabee.sigma2.no)**. *1 CPU, 1 GB memory*. The default machine, suitable for basic data analysis such as processing ground truth data, annotation, simple statistics & visualisation etc.
 ...
 * **[Medium](https://hub-medium.seabee.sigma2.no)**. *4 CPUs, 16 GB memory, 1 Tesla V100-SXM2-16GB GPU*. Suitable for machine learning.
