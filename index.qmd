...
Data handling for the SeaBee project is hosted by Sigma2 on [NIRD](https://documentation.sigma2.no/files_storage/nird.html), the National Infrastructure for Research Data. All SeaBee datasets are stored in the Sigma2 data centre at [Lefdal Mine](https://www.lefdalmine.com/) in Nordfjord, one of the greenest data centres in Europe. The SeaBee project has its own [Kubernetes](https://kubernetes.io/) namespace at Lefdal Mine. A high-level schematic of the current configuration is shown in @fig-sigma2-outline.
